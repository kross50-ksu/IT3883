...
For this assignment you will write two small python programs to implement basic network communications, we’ll call them “Program A” and “Program B”:
...
2.	Program B will listen for a string from program A. It will take the received string, convert it to all upper case, print the upper case string in Program B and send it back to Program A.
...
[Program](Assignment4_A.py)
[Program](Assignment4_B.py)

# Screenshots  

[Output](A4_ProgramA.png)
[Output](A4_ProgramB.png)
